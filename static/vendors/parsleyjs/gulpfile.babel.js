...
function buildDoc(done) {
  ...
  docco.document({
    ...
    args: sources
      ...
      .pipe($.replace('<div id="jump_page">', '<div id="jump_page"><a class="source" href="../index_bak.html"><<< back to documentation</a>'))
...
function buildDocTest() {
  return _runBrowserifyBundle(browserifyBundler(), './doc/asset/spec-build.js');
}
